...
export class UmbWorkspaceEditorContext extends UmbContextBase<UmbWorkspaceEditorContext> {
	...
	constructor(host: UmbControllerHost) {
		...
		// TODO: [LK] This is where we need to detect if the workspace has a collection and configure accordingly.
		// we'll need to access `UmbContentCollectionWorkspaceContext` in order to get the `contentType.collection` data-type unique.
