...
export default class UmbPreviewElement extends UmbLitElement {
	...
	constructor() {
		...
		//window.addEventListener('beforeunload', this.#context.exitPreview);
	}
	...
	render() {
		...
		return html`
			...
			<div id="wrapper">
				<div id="container">
					<iframe src=${this._previewUrl} title="Page preview" @load=${this.#onIFrameLoad}></iframe>
				</div>
			</div>
			<div id="menu">
				<h4>Preview Mode</h4>
